 ...
 * Sur mobile, la pose continue reste fluide sans traiter des centaines
 * d'événements inutiles par seconde. La navigation caméra est désormais
 * gérée directement par le vrai mode construction du jeu.
 */
